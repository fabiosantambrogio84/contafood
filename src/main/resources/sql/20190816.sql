...
ALTER TABLE `fornitore` ADD COLUMN blocca_ddt bit(1) NOT NULL DEFAULT b'0' AFTER id_autista;
...
ALTER TABLE `fornitore` ADD COLUMN nome_gruppo_riba bit(1) NOT NULL DEFAULT b'0' AFTER raggruppa_riba;

...
public class StampaController {
    ...
    public ResponseEntity<Resource> printFattura(@PathVariable final Long idFattura) throws Exception{
        ...
        fatturaDataSources.add(stampaService.getFatturaDataSource(fattura));

        // create list of FatturaRigheDataSource from FatturaDdts
        List<FatturaRigaDataSource> fatturaRigaDataSources = stampaService.getFatturaRigheDataSource(fattura);

        // create list of FatturaAccompagnatoriaTotaliDataSource from FatturaAccompagnatoriaTotale
        List<FatturaTotaleDataSource> fatturaTotaleDataSources = stampaService.getFatturaTotaliDataSource(fattura);
    ...
    public ResponseEntity<Resource> printFatturaAccompagnatoria(@PathVariable final Long idFatturaAccompagnatoria) throws Exception{
        ...
        FatturaAccompagnatoria fatturaAccompagnatoria = stampaService.getFatturaAccompagnatoria(idFatturaAccompagnatoria);
        ...
        fatturaAccompagnatoriaDataSources.add(stampaService.getFatturaAccompagnatoriaDataSource(fatturaAccompagnatoria));

        // create list of FatturaAccompagnatoriaRigheDataSource from FatturaAccompagnatoriaRiga
        List<FatturaAccompagnatoriaRigaDataSource> fatturaAccompagnatoriaRigaDataSources = stampaService.getFatturaAccompagnatoriaRigheDataSource(fatturaAccompagnatoria);

        // create list of FatturaAccompagnatoriaTotaliDataSource from FatturaAccompagnatoriaTotale
        List<FatturaAccompagnatoriaTotaleDataSource> fatturaAccompagnatoriaTotaleDataSources = stampaService.getFatturaAccompagnatoriaTotaliDataSource(fatturaAccompagnatoria);

...
public interface RibaConstants {

    String FILENAME_PREFIX = "export_riba_";
    ...
    String URBANI_ALIMENTARI_CAP_CITTA = "37035 S. Giovanni";

    String URBANI_ALIMENTARI_CITTA_PROVINCIA = "Ilarione (VR)";

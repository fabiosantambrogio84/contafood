...
public class EmailService {
    ...
    public EmailService(final ProprietaService proprietaService){
        ...
        this.username = proprietaService.findByNome(EmailConstants.PEC_SMTP_USER_PROPERTY_NAME).getValore();
        this.password = proprietaService.findByNome(EmailConstants.PEC_SMTP_PASSWORD_PROPERTY_NAME).getValore();
    }
    ...
    private Properties getProperties(){
        ...
        properties.put("mail.smtps.host", proprietaService.findByNome(EmailConstants.PEC_SMTP_HOST_PROPERTY_NAME).getValore());
        properties.put("mail.smtps.port", proprietaService.findByNome(EmailConstants.PEC_SMTP_PORT_PROPERTY_NAME).getValore());
    ...
    public Message createFatturaMessage(Session session, Fattura fattura, boolean isPec, byte[] reportBytes) throws Exception{
        ...
        try{
            ...
            mimeBodyPart.setContent(EmailConstants.FATTURA_BODY, EmailConstants.BODY_TYPE);
